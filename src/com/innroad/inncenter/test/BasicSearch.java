...
public class BasicSearch extends testCore {
	 ...
	 @Test(dataProvider="getData", groups="Somke")
		public void basicSearch(String url,String ClientCode, String Username, String Password,String PropertyName, String GuestName
				
				
				) throws InterruptedException, IOException
		{
			
		 ExtentTest test = extent.startTest("BasicSearch", "Basic Search")
