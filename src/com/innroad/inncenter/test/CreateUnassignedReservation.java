...
public class CreateUnassignedReservation extends testCore{
	 ...
	 @BeforeTest
		public void checkRunMode(){
			...
			if(!Utility.isExecutable("CreateUnassignedReservation", excel))
	...
	public void createUnassignedReservation(String url,String ClientCode, String Username, String Password, String MarketSegment, String Referral, String Travel_Agent, String ExtReservation,
	...
	{
    	 ExtentTest test = extent.startTest("CreateUnassignedReservation", "Unassigned reservation creation")
	...
	public Object [][] getData(){
		...
		return Utility.getData("CreateUnassignedReservation",excel);
	}
