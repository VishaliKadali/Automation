...
//		AccountName = AccountName + Utility.getTimeStamp();
		...
		try {
			...
			Utility.updateReport(e, "Failed to navigate to Reservations page", testName, "NewPolicyPage");
		...
		try {
			...
			Utility.updateReport(e, "Failed to navigate to new Policy page", testName, "VerifyResPolicy");
		}
		try {
...
//		} catch (Exception e) {
//			Utility.updateReport(e, "Failed to save the account", testName,"SaveAccount");
//
//		} catch (Error e) {
//			Utility.updateReport(e, "Failed to save the account", testName,"SaveAccount");
//		}
		...
		try {
			...
			Utility.updateReport(e,"Failed to checkin account reservation and Failed to validate Account Checkin policy", testName,"VerifyAccPolicy");
	...
	@Test(dependsOnMethods={"reservation__And_Account_Policy_Verification"},alwaysRun=true)
	public void delete_Policies()
	
{
	...
	try {
		...
		app_logs.error("Failed to Delete all created Policies");
