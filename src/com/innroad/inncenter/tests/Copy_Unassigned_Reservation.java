...
public class Copy_Unassigned_Reservation extends TestCore {
...
@Test(dataProvider="getData")
	public void copyReservationUnAssigned(String url,String ClientCode, String Username, String Password, String MarketSegment, String Referral, String Travel_Agent, String ExtReservation,
	...
	{
 	 test = extent.startTest("copyReservationUnAssigned", "create unassigned Reservation copy")
 			 				 .assignCategory("CopyReservationUnAssigned")
	     ...
	     try
		    {
	         ...
	         Utility.updateReport(e, "Failed to Copy the Reservation ", testName, "Copy_Reservation_UnAssigned");
	     	} catch (Error e) {
	         Utility.updateReport(e, "Failed to Copy the Reservation ", testName, "Copy_Reservation_UnAssigned");
	     	}
...
@DataProvider
	public Object [][] getData(){
		...
		return Utility.getData("Copy_Unassigned_Reservation",excel);
	}
