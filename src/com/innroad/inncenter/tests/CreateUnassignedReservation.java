...
public class CreateUnassignedReservation extends TestCore{
	...
	public void login(String url,String ClientCode, String Username, String Password, String MarketSegment, String Referral, String Travel_Agent, String ExtReservation,
	...
	{
    	 ExtentTest test = extent.startTest("CreateUnassignedReservation", "Executing on app.innroad.com");
