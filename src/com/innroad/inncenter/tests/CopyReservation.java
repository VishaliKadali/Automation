...
public class CopyReservation extends TestCore {
	...
	public void Copy_Reservation(String url, String ClientCode, String Username, String Password,
			...
			String Account, String saluation, String IsTaxExempt, String TaxEmptext)
			throws InterruptedException, IOException {

		test = extent.startTest("CopyReservation", "Create assigned reservation")
		...
		try {
			...
			test.log(LogStatus.PASS, "Copy the new reservation successfully");
			app_logs.info("Copy the new reservation successfully");

		} catch (Exception e) {
			Utility.updateReport(e, "Failed to Copy New Reservation", testName, "CreateReservation");
		} catch (Error e) {
			Utility.updateReport(e, "Failed to Copy New Reservation", testName, "CreateReservation");
		}
	...
	public Object[][] getData() {
		...
		return Utility.getData("CopyReservation", excel);
	}
