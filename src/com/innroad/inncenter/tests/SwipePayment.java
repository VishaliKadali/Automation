...
public class SwipePayment extends TestCore {
	...
	public void Verify_Lock_Functionality(String url, String ClientCode, String Username, String Password,
			String propertyName, String MargetSegment, String Referral, String FirstName, String LastName,
			String Phonenumber, String alternativeNumber, String Address1, String Address2, String Address3,
			String Email, String city, String State, String Postalcode, String SelectCategory, String RoomClass,
			String Payment_Type, String ClientType, String Line1, String Line2, String Line3, String Country,
			String Account, String saluation, String IsTaxExempt, String TaxEmptext, String Amount, String CardNumber)
			throws InterruptedException, IOException {

		test = extent.startTest("SwipePayment", "Swipe a payment").assignCategory("Reservation")
		...
		try {
			...
			payament.Card_Swipe_Payment(driver, Amount, Payment_Type, CardNumber);
			res.SaveReservation(driver);
			test.log(LogStatus.PASS, "Payment Via Swipe Card succussfully");
			app_logs.info("Payment Via Swipe Card succussfully");
		} catch (Exception e) {
			Utility.updateReport(e, "Failed to Payment Via Swipe Card", testName, "SwipeCard");
		} catch (Error e) {
			Utility.updateReport(e, "Failed to Payment Via Swipe Card", testName, "SwipeCard");
		}
	...
	public Object[][] getData() {
		...
		return Utility.getData("SwipePayment", excel);
	}
