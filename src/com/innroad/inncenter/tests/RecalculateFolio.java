...
public class RecalculateFolio extends TestCore {
	...
	public void Recalculate_Folio(String url, String ClientCode, String Username, String Password, String propertyName,
		...
		test = extent.startTest("RecalculateFolio", "Recalculate Folio").
		...
		try {
			res.Recalcualte_Folio(driver);
			res.SaveReservation(driver);
			test.log(LogStatus.PASS, "Recalculate Folio successfully");
			app_logs.info("Recalculate Folio successfully");

		} catch (Exception e) {
			Utility.updateReport(e, "Failed to Recalculate Folio", testName, "RoomChargesChanged");
		} catch (Error e) {
			Utility.updateReport(e, "Failed to Recalculate Folio", testName, "RoomChargesChanged");
		}
	...
	public Object[][] getData() {
		...
		return Utility.getData("RecalculateFolio", excel);
	}
