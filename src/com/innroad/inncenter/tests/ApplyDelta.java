...
public class ApplyDelta extends TestCore {
	...
	public void Apply_Delta(String url, String ClientCode, String Username, String Password, String propertyName,
		...
		test = extent.startTest("ApplyDelta", "Apply Delta").assignCategory("Reservation").assignCategory("Regression");
		...
		try {
			res.Apply_Delta(driver);
			res.SaveReservation(driver);
			test.log(LogStatus.PASS, "Apply delta successfully");
			app_logs.info("Apply delta successfully");

		} catch (Exception e) {
			Utility.updateReport(e, "Failed to apply delta successfully", testName, "RoomChargesChanged");
		} catch (Error e) {
			Utility.updateReport(e, "Failed to apply delta successfully", testName, "RoomChargesChanged");
		}
	...
	public Object[][] getData() {
		...
		return Utility.getData("ApplyDelta", excel);
	}
