...
public class Associate_Account_To_Reservation extends TestCore{
	@BeforeTest
	...
	public void associateAccount(String url,String ClientCode, String Username, String Password, String MarketSegment, String Referral, String Travel_Agent, String ExtReservation, String saluation, 
		...
		try
		{
			...
			Utility.updateReport(e, "Failed to Create Reservation", testName, "Reservation");
		} catch (Error e) {
			Utility.updateReport(e, "Failed to Create Reservation", testName, "Reservation");
		}
	...
	public Object [][] getData(){
		...
		return Utility.getData("AssociateAccountToReservation",excel);
	}
}
