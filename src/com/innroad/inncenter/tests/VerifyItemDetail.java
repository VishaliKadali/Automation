...
public class VerifyItemDetail extends TestCore {
	 ...
	 @BeforeTest
		public void checkRunMode(){
			...
			if(!Utility.isExecutable("VerifyItemDetail", excel))
				throw new SkipException("Skipping the test");
			app_logs.info("Verifying Test case is Skipped or not");	
		}
	 
	 @Test(dataProvider="getData")
		public void verifyItemDetails(String url,String ClientCode, String Username, String Password, String MarketSegment, String Referral, String Travel_Agent, String ExtReservation,
		...
		{
	    	 ExtentTest test = extent.startTest("VerifyItemDetail", "Verifying Item Detail")
	 ...
	 try{
	     ...
	     try{
	    	 ...
	    	 test.log(LogStatus.FAIL, "Failed to Verify Line Item Details"); 
	     }
	     extent.endTest(test);
