...
public class Account implements IAccount {
	...
	public void get_AccountDetails(WebDriver driver, ExtentTest test, String AccountType, String AccountName)
		 ...
		 * "//div[@id='toast-container']/div/div")).size()>0){
		 * 
		 * break; }else if(i<0){ test.log(LogStatus.PASS,
		 * "There are No Accounts available with "+AccountName
		 * +" and Account Number "+AccountNumber);
		 * accountsLogger.info("There are No Accounts available with "
		 * +AccountName +" and Account Number "+AccountNumber); break; }else{
		 * Wait.wait1Second(); i++; } }
		 */
	...
	public void AccountAttributes(WebDriver driver, ExtentTest test, String MargetSegment, String Referral)
			throws InterruptedException {
	...
	public String  getAccountNumber(WebDriver driver,ExtentTest test,String AccountName) throws InterruptedException{
		...
		Wait.WaitForElement(driver, "//span[contains(text(),'"+AccountName.trim()+"')]/following-sibling::span[2]");
		WebDriverWait wait = new WebDriverWait(driver,90);
	...
	public void Mailinginfo(WebDriver driver, ExtentTest test, String AccountFirstName, String AccountLastName,
			String Phonenumber, String alternativeNumber, String Address1, String Address2, String Address3,
			String Email, String city, String State, String Postalcode) {

		Wait.WaitForElement(driver, OR.Account_Enter_First_Name);
		Elements_Accounts CreateAccount=new Elements_Accounts(driver);
	...
	public void cashPayment(WebDriver driver, ExtentTest test, String AccountType, String AccountName,
			String AmountToPay, String PaymentType) throws InterruptedException {
		...
		if (bal > 0) {
			...
			if(AccountType.contains("Corporate")){
				...
				Wait.WaitForElement(driver, "//span[contains(text(),'Payment Details')]/../../../../following-sibling::div/div/div/div/div/div/ul/li/div/button[contains(text(),'Add')]");
	...
	public void ageingPayment(WebDriver driver, ExtentTest test, String AccountType, String PaymentType,
			String CardName, String CCNumber, String CCExpiry, String CCVCode, String Authorizationtype,
			String ChangeAmount, String ChangeAmountValue) throws InterruptedException {
		Elements_Accounts AccountPayment = new Elements_Accounts(driver);
		Wait.wait2Second();
		...
		if(PaymentType.equalsIgnoreCase("MC")){
			...
			if(Authorizationtype.equalsIgnoreCase("Capture"))
			{
				...
				Wait.WaitForElement(driver, "//table[@class='table table-condensed table-striped table-borderd table-hover table-bordered']/tbody[1]/tr[1]/td[2]/span");
			String text=driver.findElement(By.xpath("//table[@class='table table-condensed table-striped table-borderd table-hover table-bordered']/tbody[1]/tr[1]/td[2]/span")).getText();
			driver.findElement(By.xpath("//table[@class='table table-condensed table-striped table-borderd table-hover table-bordered']/tbody[1]/tr[1]/td[1]/input")).click();
			AccountPayment.Click_Process_Account.click();
	...
	public void ageingPaymentAutoApply(WebDriver driver, ExtentTest test, String AccountType, String PaymentType,
			String CardName, String CCNumber, String CCExpiry, String CCVCode, String Authorizationtype,
			String ChangeAmount, String ChangeAmountValue) throws InterruptedException {
		...
		if (PaymentType.equalsIgnoreCase("MC")) {
			...
			if(Authorizationtype.equalsIgnoreCase("Capture"))
			{
				...
				//Wait.wait2Second();
				Wait.WaitForElement(driver, "//table[@class='table table-condensed table-striped table-borderd table-hover table-bordered']/tbody[1]/tr[1]/td[1]/input");
				if(driver.findElement(By.xpath("//table[@class='table table-condensed table-striped table-borderd table-hover table-bordered']/tbody[1]/tr[1]/td[1]/input")).isSelected()){
					text=driver.findElement(By.xpath("//table[@class='table table-condensed table-striped table-borderd table-hover table-bordered']/tbody[1]/tr[1]/td[2]/span")).getText();
				}
			}
	...
	public void ageingPaymentAdvanceDeposit(WebDriver driver, ExtentTest test, String AccountType, String PaymentType,
			String CardName, String CCNumber, String CCExpiry, String CCVCode, String Authorizationtype,
			String ChangeAmount, String ChangeAmountValue) throws InterruptedException {
...
public void AccountSave(WebDriver driver,ExtentTest test,String AccountName) {
		...
		assertEquals(Toast_Message,
				"The account "+AccountName+" has been successfully created.", "New account does not create");
		
		test.log(LogStatus.PASS,Toast_Message);
