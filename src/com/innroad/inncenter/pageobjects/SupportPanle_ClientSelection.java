...
public void Client_Selection_WithId(WebDriver driver, String clientCode) throws InterruptedException {
		...
		Wait.explicit_wait_visibilityof_webelement(ClientSelection.Pencil_Icon);
		ClientSelection.Pencil_Icon.click();
		Wait.explicit_wait_visibilityof_webelement(ClientSelection.Enter_client_TextBox);
		ClientSelection.Enter_client_TextBox.sendKeys(clientCode);
		Wait.explicit_wait_visibilityof_webelement(driver.findElement(By.xpath("//li//small[text()='"+clientCode+"']")));
		driver.findElement(By.xpath("//li//small[text()='"+clientCode+"']")).click();
		Wait.explicit_wait_visibilityof_webelement(ClientSelection.Settings_Icon);
