...
public class AssociateReservationGuestHistory implements IAssociateReservationGuestHistory {
	...
	public void Save(WebDriver driver) throws InterruptedException {
		...
		public void associateGuestToReservation(WebDriver driver, String GuestProfile) throws InterruptedException		{
			...
			Wait.wait10Second();
			Wait.explicit_wait_xpath(OR.findGuestProfile);
			...
			//action.moveToElement(res.selectGuest).build().perform(); 
			res.selectGuest.click();
			Wait.wait15Second();
			//Wait.explicit_wait_xpath(OR.continueButton);
			
			WebDriverWait wait = new WebDriverWait(driver, 150);
			//WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(OR.continueButton)));
			Wait.wait10Second();
			res.continueButton.click();
			Wait.wait10Second();
			//WebDriverWait wait1 = (WebDriverWait) (new WebDriverWait(driver, 150)).until(ExpectedConditions.presenceOfElementLocated(By.xpath(OR.reservation_Save)));
