...
public void checkAvailabilityWithPromoCode(WebDriver driver, String TapeChartAdults, String TapeChartChildrens, String PromoCode ) throws InterruptedException {
	Elements_Reservation_PromoCode ResPromoCode = new Elements_Reservation_PromoCode(driver);
...
public void click_availableRoomClass(WebDriver driver)  throws InterruptedException {
	...
	try
	{
		WebElement availableCell=driver.findElement(By.xpath("(.//*[@id='bpjscontainer_52']//div[contains(@title,'Available')])[2]"));
...
//		 driver.findElement(By.xpath("//div[@class='tapechartdatecell Available RackRate']")).click();
	...
	catch(Exception e)
	{
		...
		try{
			WebElement availableCell1=driver.findElement(By.xpath("(.//*[@id='bpjscontainer_52']//div[contains(@title,'Available')])[4]"));
