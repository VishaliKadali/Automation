...
>>>>>>> feature/AUTOMATION-90
	...
	public static final String Click_Unassigned_Tapechart = "(//div[contains(text(),'Unassigned12')])[1]"; // "//div[@class='roomClasses']//div[@class='roomRatesChart'][1]//div[@class='row
																											// unassignedrow']//div[@class='col-xs-1']";
	...
	public static final String Folio_Cash_Continue_Btn = "//span[contains(text(),'Payment Details')]/../../../../following-sibling::div/div/div/button[contains(text(),'Continue')]";// span[contains(text(),'Payment
																																														// Details')]/../../../../following-sibling::div/div/div/button[contains(text(),'Continue')]";
	...
	public static final String ReservationSaveButton = "//button[.='Save']";
	...
	public static final String AddButton = "//button[text() = 'Add']";
	public static final String SelectCategory = ".trHeight25 tbody tr td select";
	public static final String LineItemsFields = ".trHeight25 tbody tr td input";
	...
	public static final String Add_Pay_Button = "//span[@id='bpjscontainer_28']//button[contains(@data-bind,'visible: $parent.isAddButtonVisible')]";
	...
	public static final String Enter_CardName = "//span[@id='bpjscontainer_32']//input[contains(@data-bind,'value: NameOnCard')]";
	public static final String Enter_CardNum = "//span[@id='bpjscontainer_32']//input[contains(@data-bind,'value: $root.txtBilling_AccountNumber')]";
	public static final String Enter_ExpDate = "//span[@id='bpjscontainer_32']//input[contains(@data-bind,'value: ExpDate')]";
	public static final String Enter_Card_CVVCode = "//span[@id='bpjscontainer_32']//input[contains(@data-bind,'value: CvvCode')]";
	public static final String Enter_Address = "//span[@id='bpjscontainer_32']//input[contains(@data-bind,'value: Address1')]";
	public static final String Enter_Card_City = "//span[@id='bpjscontainer_32']//input[contains(@data-bind,'value: City')]";
	public static final String Enter_Card_State = "//span[@id='bpjscontainer_32']//input[contains(@data-bind,'value: State')]";
	public static final String Enter_PostalCode = "//span[@id='bpjscontainer_32']//input[contains(@data-bind,'value: PostalCode')]";
	public static final String Enter_ApprovalCode = "//span[@id='bpjscontainer_32']//input[contains(@data-bind,'value: ApprovalCode')]";
	public static final String CardOK_Button = "//span[@id='bpjscontainer_32']//button[contains(@data-bind,'click: btnOKClick')]";
	...
	public static final String BlackoutsLink = "MainContent_btnBlackOut";
	public static final String BlackoutsLink1 = "//li[contains(@data-bind,'css: showBlackoutsContent() ?')]";

	public static final String BlackOutRoomCheckBox = "table tr td input";
	public static final String BlackOutRoom_Save_Button1 = ".footer_buttons button";
	public static final String BlackOutRoom_Save_Button = "MainContent_btnSave";
