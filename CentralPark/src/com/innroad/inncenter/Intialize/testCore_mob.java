...
public class testCore_mob {
	
//	path variables
	public static String extentReportsPath = System.getProperty("user.dir") + "/extent-reports";
	public static String testDataPath = System.getProperty("user.dir") + "/test-data";
	public static String configFilesPath = System.getProperty("user.dir") + "/config-files";
	
//	public static final ExtentReports extent = new ExtentReports(".\\extent-reports\\reports.html", false);
...
//			FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"\\src\\com\\innroad\\inncenter\\properties\\config");
			...
			fis = new FileInputStream(System.getProperty("user.dir")+"\\src\\com\\way2automation\\twitter\\config\\OR.properties");
			object.load(fis);
			app_logs.debug("Object property file loaded");
			
			///fis = new FileInputStream(System.getProperty("user.dir")+"\\src\\com\\innroad\\inncenter\\properties\\OR.java");
			or1=new OR();
			app_logs.debug("Object property file loaded : " + or1.clientCode);
	*/
			//load the Excel file
//			excel = new excel_reader(System.getProperty("user.dir")+"\\src\\com\\innroad\\inncenter\\testdata\\TestData.xlsx");
...
//			app_logs.info("Entered URL");
	...
	/*public void loadconfig() throws IOException
	{
		...
		if(config.getProperty("browser").equals("firefox")){
			...
			System.setProperty("webdriver.ie.driver", "U:\\InnRoad_DataDriven_FrameWork\\Drivers\\IEDriverServer.exe");
			driver = new InternetExplorerDriver();
			app_logs.info("IE driver initialized");
			driver.manage().window().maximize();
			app_logs.info("window Maximize");
