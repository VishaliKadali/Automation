...
public class Reservation_MCPayment extends testCore {
	 ...
	 @Test(dataProvider="getData")
		public void Reservation_mCPayment (String url,String ClientCode, String Username, String Password,String PropertyName, String MarketSegment, String Referral, String Travel_Agent, String  ExtReservation,
		 ...
		 ExtentTest test = extent.startTest("Reservation_MCPayment","Creating reservation with payment method as Master Card")	
